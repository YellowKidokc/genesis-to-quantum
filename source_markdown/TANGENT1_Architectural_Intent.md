...
**Axiom (2)**
- `Axiom` [Defense Depth](https://www.oxfordreference.com/view/10.1093/acref/defense+depth)
- `Axiom` Systemic Integration

**Claim (5)**
- `Claim` Theophysics was constructed to maximize [Defense Depth](https://www.oxfordreference.com/view/10.1093/acref/defense+depth) and Systemic Integration -> parent: [Defense Depth](https://www.oxfordreference.com/view/10.1093/acref/defense+depth)
...
```mermaid
---
title: TANGENT1 Architectural Intent
---
flowchart LR
    fc5fb7ef("Theophysics was constructed to")
    072171ac("No axiom was accepted unless i")

    %% Styles
    style fc5fb7ef fill:#00838f,color:#fff
    style 072171ac fill:#00838f,color:#fff
```
%%tag::Axiom::3a354293-22e5-4a53-93b0-6253e0791fd0::"[Defense Depth](https://www.oxfordreference.com/view/10.1093/acref/defense+depth)"::null%%
%%tag::Axiom::0096c4b6-3f88-4f8a-b064-7353d650c49b::"Systemic Integration"::null%%
%%tag::Claim::fc5fb7ef-7028-4d5e-8972-ac65515fafeb::"Theophysics was constructed to maximize [Defense Depth](https://www.oxfordreference.com/view/10.1093/acref/defense+depth) and Systemic Integration"::3a354293-22e5-4a53-93b0-6253e0791fd0%%
